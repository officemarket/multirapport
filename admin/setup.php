...
$formSetup->newItem('CreditStatusConfiguration')->setAsTitle();

// Setup conf for boolean Credit Status
$formSetup->newItem('MULTIRAPPORT_INVOICE_CREDIT_STATUS_ENABLED')->setAsYesNo();
